...
The aim of this demo is to showcase how to conduct randomization and power analyses in clinical trial designs. R has a suite of packages geared towards clinical trial design, monitoring, and analyses (CRAN R Projects- Clinical Trials @zhang_cran_2021). I'm also modeling my demo off of Peter Higgin's *Reproducible Medical Research with R* book, chapter 20 (@higgins_2023). 
...
## Time to event types of designs  
...
nSurvival(
  ...
  Ts = 24, #24 months
  Tr = 6, # 6 months
  eta = .1, # 1 per month dropout rate
