...
* Demo'ing [tidyverse](ggplot.html) starting from a fruit fly dataset to publication quality figures
  * barplots, scatterplots, multi-panel plots in ggplot2   
...
* Surveyed ants for gene expression exposed to experimental warming in nature [warming](20170508_stressed_ants_report_forSHC_NJG.html)  
