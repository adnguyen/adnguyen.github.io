...
I'll be demo'ing the tidyverse, surival analysis, and SVM on a project I worked on in my postdoc at the Unversity of Florida. The project details are publicly available through this github repository. 
...
There's no variation in group 1 (early eclosers) and group 3(late eclosers) have very few sample sizes. We can partition data to just focus on group 2 (medium eclosers).    
...
There is a staticial trend (not significant) for a host by treatment interaction such that there flies emerging from hawthorne fruit have a slower rate of eclosion compared to applies under SO than RT treatments. This is all focused on the group 2 eclosers (medium timing).  
